...
if __name__ == '__main__':
    ...
    regex = re.compile ('series[0-9]+_.csv')
    bind_csv (args, regex)
    regex2 = re.compile ('series[0-9]+_nuc_seg.csv')
    bind_csv (args, regex2, label='cyto')
    regex3 = re.compile ('series[0-9]+_cyto_seg.csv')
    bind_csv (args, regex3, label='nuc')
